...
|---|---|---|
| 主戦場 | ソフトウェア開発 | 社内業務エージェント基盤 |
| 得意なこと | コード読解、修正、テスト | 複数チャネル・複数情報源をつないだ作業支援 |
| 操作対象 | リポジトリ、ローカル開発環境、IDE/CLI | GitLab、共有フォルダ、Obsidian、Symphony、社内API |
| 利用イメージ | 開発者が開発タスクを依頼 | チャットやWeb UIから業務文脈のある作業を依頼 |
| 強み | コーディング体験が洗練されている | 接続先・利用チャネル・常駐エージェント化の自由度 |
...
**Claude Code / Codex**
- 強力な coding agent
- リポジトリを読んで、コードを修正し、テストを実行する
- 開発者個人の生産性向上に強い

**OpenClaw**
- 社内環境に接続する assistant / agent 基盤
- GitLab、共有フォルダ、Obsidian、Symphonyなどを横断できる
- 業務文脈の整理・調査・連携に強い

<br>

**コーディングなら Claude Code / Codex。社内情報源をつないだ業務エージェントなら OpenClaw。**
